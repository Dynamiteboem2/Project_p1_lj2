...
<body>
    ...
    <div class="container">
      ...
      <div class="ticket-cards">
        ...
        <div class="ticket-card">
          ...
          <button class="ticket-btn" data-event="Budapest 2024" data-date="23-24 OKTOBER, 2024">Boek
            Nu</button>
        </div>
        ...
        <div class="ticket-card">
          ...
          <button class="ticket-btn" data-event="Rotterdam 2024" data-date="26-27 OKTOBER, 2024">Boek
            Nu</button>
        </div>
        ...
        <div id="popup">
          <div id="popup-content">
            ...
            <form id="payment-form" method="post" action="<?php echo URL ?>/db/createTicket.php">
              <label for="event-select">Kies een evenement:</label>
              <select id="event-select" required name="event-select">
              ...
              <div id="ticket-quantity-wrapper">
                ...
                <input type="number" name="ticket-quantity" id="ticket-quantity" min="1" max="10"
                  value="1" required>
  ...
  <style>
    ...
    #ticket-quantity-wrapper {
      ...
      /* Verdeling van de knoppen en het invoerveld */
      align-items: center;
      width: 100%;
      /* Volledige breedte van de pop-up */
      margin: 10px 0;
    }

    #ticket-quantity-wrapper button {
      flex: 1;
      /* Zorg ervoor dat knoppen gelijkmatig de ruimte gebruiken */
      height: 40px;
      font-size: 18px;
      border: 1px solid #ccc;
      background-color: #f95a1a;
    ...
    #payment-form {
      width: 100%;
      /* Zorg ervoor dat het formulier de volledige breedte heeft */
    }
